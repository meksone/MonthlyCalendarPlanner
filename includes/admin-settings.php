...
function mk_mcp_register_settings_page() { add_submenu_page('edit.php?post_type=monthly_calendar', __('Calendar Styling', 'mk-monthly-calendar-planner'), __('Styling', 'mk-monthly-calendar-planner'), 'manage_options', 'mk-mcp-settings', 'mk_mcp_render_settings_page'); }
...
function mk_mcp_render_settings_page() {
    ...
    <div class="wrap mk-mcp-settings-wrap">
        <form action="options.php" method="post">
            <div class="mk-mcp-settings-header"><h1><?php echo esc_html(get_admin_page_title()); ?></h1><?php submit_button(__('Save Settings', 'mk-monthly-calendar-planner'), 'primary', 'submit', false); ?></div>
            <?php settings_fields('mk_mcp_style_settings_group'); do_settings_sections('mk-mcp-settings'); ?>
        </form>
    </div>
    <?php
}
...
function mk_mcp_settings_api_init() {
    ...
    add_settings_field('show_calendar_title', __('Show Calendar Title', 'mk-monthly-calendar-planner'), 'mk_mcp_render_checkbox_field', 'mk-mcp-settings', 'mk_mcp_section_general', ['id' => 'show_calendar_title']);
